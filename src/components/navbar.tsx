                ...
                >
                    ...
                    {/* <nav className="flex">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-48">
                                <DropdownMenuItem onClick={() => alert("Download started")}>Download</DropdownMenuItem>
                                <DropdownMenuItem onClick={() => alert("Sharing link copied")}>Share</DropdownMenuItem>
                                <DropdownMenuItem onClick={() => alert("Archived")}>Archive</DropdownMenuItem>
                    ...
                    {/* <a data-v-f62d9f74=""
                        ...
                        className="router-link-active 
                                ...
                                logo mono w-[87px] mx-4 block 
                                lg:hidden mx-4 block lg:hidden"
                    >
                        <span data-v-f62d9f74=""
                            className="sr-only"
                        >
                            n8n.io
                        </span>
